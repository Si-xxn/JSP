...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String num = request.getParameter("num"); // 제목 클릭 시 넘어오는 번호
	...
	boardDAO.close(); // 5단계
%>    
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>View.jsp : 제목 클릭 시 상세보기 페이지</title>
<script type="text/javascript">
/* 삭제 판단 */
	function deletePost(){ /* 하단 삭제 버튼 클릭 시 동작 */
		var confirmed = confirm("게시글을 삭제하시겠습니까?") /* yes = true | no = false */
		if(confirmed){ // confirm - true
			var form = document.WriteFrm; // 아래 Form 객체를 변수에 넣음		
			form.method = "post";
...
<body>
<jsp:include page="../Common/Link.jsp"  /> <!-- 메뉴 출력용 -->
	...
	<form name="WriteFrm">
		...
		<table border="1" width="90%">
			<tr>
				...
				<td>작성자</td> <td><%=boardDTO.getId() %></td>	
			</tr>
			<tr>
			...
			<tr>
				<td>내용</td><td colspan="3" height="100"><%=boardDTO.getContent().replace("\r\n", "<br>") %></td> <!-- 엔터처리 -->
			</tr>
			<tr>
				<td colspan="4" align="center"> <!-- 수정, 삭제, 리스트 버튼 | 로그인 상태 & 작성자 일치-->
					<%
