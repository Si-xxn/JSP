...
<head>
<meta charset="UTF-8">
<title>RequestMain.jsp : 요청에 대한 처리를 담당</title>
</head>
<body>
	<!-- Request 는 클라이언트(고객)가 값을 요청할 때 처리되는 내장된 메모리 영역 -->
	<!-- 메서드는 2개 get 방식 / post 방식이 있다. -->
	<!-- get 방식은 URL 을 통해서 요청하는 방법 - 가볍다, 보안상 좋지 않다. -->
	<!-- post 방식은 body 를 통해서 요청하는 방법 - 보안상 좋고, 대용량 처리가 가능, 무겁다. -->

	<h1>1. 클라이언트와 서버의 환경정보 읽기</h1>
	<a href="./RequestWebInfo.jsp?eng=hello&han=안녕">get 방식의 URL로 요청함</a>
	<br>
	<hr>
	...
	<form method="post" action="RequestParameter.jsp">
		...
		자기소개 : <!-- textarea : 설명창 -->
		<textarea rows="4" cols="30" name="intro">자기소개합니다.</textarea>
